...
def app():
    ...
    my_canvas = Label(root, image=ImageTk.PhotoImage(image_background))
    my_canvas.place(x=1, y=5, width=490, height=300)
    ...
    image_labels = ["Deer", "Elephant", "Giraffe", "Gorilla", "Horse", "Lion", "Parrot", "Peacock", "Rabbit",
                    "Squirrel"]
    ...
    def start_image_switch():
        ...
        while True:
            ...
            Label(root, image=im_Tk[count]).place(x=1, y=5, width=490, height=300)
            time.sleep(1)
